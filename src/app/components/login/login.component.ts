...
export class LoginComponent implements OnInit {
  ...
  registro(registroForm:any){
    if(registroForm.valid){
      this.new_user.password = this.new_user.password.toLowerCase();
      if(this.new_user.password.length <=5){
        ...
        this.new_user.email = this.new_user.email.toLowerCase();
        this.new_user.password = this.new_user.password.toLowerCase();   
          ...
          response=>{            
            if(response.data != undefined){
              iziToast.show({
                  ...
                  class: 'text-success',
                  position: 'topRight',
                  message: 'Se registro correctamente en The Blossom.'
              });
